...
<body>
    ...
    <main>
        ...
        <form name='login_form' method='post'>
            ...
            <div class="username">
                <label>Username <br><input type='text' name='username' value='<?php echo e(old('username')); ?>'>
            ...
            <span>Do not have an account?</span><a id="sign"href="<?php echo e(url('register')); ?>">Sign up</a>
        </form>
    </main>
</body>
